    ...
    <div className='xl:w-[600px] hidden lg:inline ml-8 space-y-5'>
      ...
      <div className='sticky top-16 text-gray-700 space-y-3 bg-gray-100 pt-2 rounded-xl w-[90%] xl:w-[75%]'>
        ...
        {randomUsersResults.slice(0, randomUserNumber).map((randomUser) => (
          <div key={randomUser.login.username} className="flex items-center px-4 py-2 cursor-pointer hover:bg-gray-200 transition duration-1000 ease-out">
            <img className='rounded-full' width="40" src={randomUser.picture.thumbnail} alt="" />
            <div className='truncate lm-4 leading-5'>
